...
class TournamentListCollectionViewCell: UICollectionViewCell {
    ...
    private func prepareLayout() {
        ...
        ticketIcon.activeSelfConstrains([.width(8)])
        ...
        entryFeeLabel = UILabel.formatedLabel(size: 12, text: "", type: .bold, textAlignment: .left)
        ...
        entryFeeLabel.activeSelfConstrains([.height(30)])
